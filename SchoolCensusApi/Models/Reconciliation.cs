...
namespace SchoolCensusApi.Models
{
    ...
    {
        public int Reconciliations_id { get; set; }
        public string SurveyID { get; set; }
        public string Entity { get; set; }
        public string Section { get; set; }
        public Nullable<int> RoomsForClasses { get; set; }
        public Nullable<int> TotalSections { get; set; }
        public Nullable<int> ClassesWithoutRooms { get; set; }
        public Nullable<int> RoomsUnderConstrustion { get; set; }
